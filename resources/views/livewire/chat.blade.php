<div class="flex h-[90vh] chat-container max-w-7xl mx-auto shadow-xl rounded-lg overflow-hidden mt-5">
        ...
        <div class="overflow-y-auto h-full pb-16">
            @foreach($this->getChatUsers() as $pengirim)
                <div wire:click="openChat({{ $pengirim->id }})"
                    ...
                    <div class="w-12 h-12 flex items-center justify-center rounded-full bg-[#a01800] text-white text-lg font-semibold">
    ...
    <div id="chat-window" class="w-1/2 flex flex-col bg-white">
        ...
        <div class="p-4 border-t border-gray-200 bg-white">
            <form wire:submit.prevent="submit" class="flex items-center gap-2 p-4 max-w-4xl mx-auto">
                ...
                <button type="submit"
                    class="bg-blue-500 hover:bg-blue-600 text-white px-5 py-3 rounded-full text-sm">
                    Kirim
                </button>
            </form>
        </div>

    ...
    @if($transaksi)
        @foreach ($transaksi as $item)
            ...
            <div class="w-full sm:w-2/3 md:w-1/2 lg:w-1/2 mx-auto my-4">
                ...
                <div class="bg-amber-50 p-5 rounded-xl shadow-lg border border-amber-100 relative
                        ...
                        <div class="flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden border bg-white">
                            @foreach ($daftar_produk as $detail_product)
                                <img class="w-full h-full object-cover"
                                    src="{{ asset('images/product/' . $detail_product['gambar']) }}"
                                    alt="Gambar Produk">
                            @endforeach
                        </div>
                    ...
                    <div class="flex flex-col mt-4 gap-2">
                        ...
                        <div
                            class="flex items-center text-sm text-gray-500 space-x-4 border-b border-gray-300 pb-3">
